module.exports = class DirectLineWrapper {
  ...
  sendMessage(user, message, userId, app) {
    // Patch if user isn't provided
    user = user || {};

    var channelData = {
      gapp_conversationId : app.getConversationId(),
      gapp_availableSurfaces : app.getAvailableSurfaces(),
      gapp_DeviceLocation : app.getDeviceLocation()
    };
